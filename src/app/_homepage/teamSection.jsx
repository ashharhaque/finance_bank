...
const TeamSection = () => (
  <section id="ourfounders" className="py-16 bg-gradient-to-br from-orange-50 to-white">
    <div className="container mx-auto px-4">
      {/* Added extra margin-bottom for the title */}
      <h2 className="text-center font-heading mb-12 bg-orange-100 text-orange-800 px-6 py-3 rounded-xl md:w-96 md:mx-auto text-lg md:text-2xl font-bold tracking-widest uppercase title-font">
        Meet Our Founders
      </h2>
      {/* Added margin-top to separate the grid from the title */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-12 max-w-6xl mx-auto mt-20">
